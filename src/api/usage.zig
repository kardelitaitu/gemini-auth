...
pub fn fetchActiveUsage(allocator: std.mem.Allocator, gemini_home: []const u8) !?registry.RateLimitSnapshot {
    const result = try fetchActiveUsageDetailed(allocator, gemini_home);
    return result.snapshot;
}

pub fn fetchActiveUsageDetailed(allocator: std.mem.Allocator, gemini_home: []const u8) !UsageFetchResult {
